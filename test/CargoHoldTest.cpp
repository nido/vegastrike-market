...
void CargoHoldTest::testDelCargo()
{
	...
	result = this->hold1.delCargo(this->in1);
	CPPUNIT_ASSERT(result == false);
	result = this->hold2.delCargo(stuff1, 150);
	CPPUNIT_ASSERT(result == false);

	result = this->hold2.delCargo(stuff1, 50);
	CPPUNIT_ASSERT(result == true);

	// hold 1 is empty.
	// hold 2 has 50 stuff1, 100 stuff2
	CPPUNIT_ASSERT(this->hold2.findCargo(stuff1)->getCount() == 50);
	// hold 3 has 100 stuff1, 100 stuff3
	result = this->hold2.delCargo(in1);
	CPPUNIT_ASSERT(result == false);
	...
	CPPUNIT_ASSERT(this->hold2.findCargo(stuff1) == NULL);
	// hold 3 has 100 stuff1, 100 stuff3
	result = this->hold2.delCargo(stuff1, 50);
	CPPUNIT_ASSERT(result == false);
	...
	// hold 2 has 100 stuff2
	// hold 3 has 100 stuff1, 100 stuff3
	result = this->hold2.delCargo(hold3);
	CPPUNIT_ASSERT(result == false);

	// hold 1 is empty.
	// hold 2 has 100 stuff2
	// hold 3 has 100 stuff1, 100 stuff3
	this->hold2.addCargo(this->hold3);

	// hold 1 is empty.
	// hold 2 has 100 stuff1, 100 stuff2, 100 stuff3
	// hold 3 has 100 stuff1, 100 stuff3
	result = this->hold2.delCargo(this->hold3);
	CPPUNIT_ASSERT(result == true);
	...
	// hold 2 has 100 stuff2
	// hold 3 has 100 stuff1, 100 stuff3
	this->hold1.addCargo(this->hold3);
	...
	// hold 2 has 50 stuff1, 100 stuff2
	// hold 3 has 100 stuff1, 100 stuff3
	result = this->hold3.delCargo(this->hold1);
	CPPUNIT_ASSERT(result == false);
	// hold 1 has 200 stuff1, 200 stuff3
	// hold 2 has 50 stuff1, 100 stuff2
	// hold 3 has 100 stuff1, 100 stuff3
