...
//begin test
    ...
    ProductionOption poPopulace(populace_outputs, populace_inputs, 1000.0,
                                 populace_costofanother);
    ...
    ProductionOption machinery(machinery_outputs, machinery_inputs, 10.0,
                                machinery_costofanother);
    ...
    ProductionOption workforce(workforce_outputs, workforce_inputs, 10.0,
                                workforce_costofanother);
