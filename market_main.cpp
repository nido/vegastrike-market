...
// the main function is just some code to test the btree and the market.
    ...
    const int n = 1000;
         ...
         */ 
                  ...
                  current->m_key ? "!" : " ") << "key=" << current->
            m_key << " second key=" << current->
            m_secondkey << " amount=" << current->m_payload.
            first << " bidder=" << current->m_payload.second << " ";
    ...
     cerr << "tree traversed backwards, " << countb << " elements" <<
        endl;
    ...
    cerr << "max market price buying 88: " << market_price << " total: "
        << accumulated << endl;
        ...
        market.min_market_price_when_selling_n(222, accumulated);
    cerr << "min market price selling 222: " << market_price << " total: "
        << accumulated << endl;
