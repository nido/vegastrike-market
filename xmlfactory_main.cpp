...
//begin test
            ...
            //==========================
            Factory * populace =
            new Factory(1000000, economy, 0.001, "population");
        ...
        ProductionOption poPopulace(populace_outputs, populace_inputs,
                                     1000.0, populace_costofanother);
            ...
            //==========================
            Factory * lands =
            new Factory(1000000, economy, 0.001, "lands");
        ...
        ProductionOption poLands(lands_outputs, lands_inputs, 50.0,
                                  lands_costofanother);
            ...
            //==========================
            Factory * brewery =
            new Factory(1000000, economy, standard_profitrate, "brewery");
        ...
        ProductionOption beer(beer_outputs, beer_inputs, 10.0,
                               beer_costofanother);
        ...
        ProductionOption wine(wine_outputs, wine_inputs, 10.0,
                               wine_costofanother);
            ...
            //==========================
            Factory * farm =
            new Factory(1000000, economy, standard_profitrate, "farm");
        ...
        ProductionOption hop(hop_outputs, hop_inputs, 10.0,
                              hop_costofanother);
        ...
        ProductionOption seeds(seeds_outputs, seeds_inputs, 10.0,
                                seeds_costofanother);
        ...
        ProductionOption grapes(grapes_outputs, grapes_inputs, 10.0,
                                 grapes_costofanother);
            ...
            //==========================
            Factory * factory =
            new Factory(1000000, economy, standard_profitrate, "factory");
        ...
        ProductionOption machinery(machinery_outputs, machinery_inputs,
                                    10.0, machinery_costofanother);
        ...
        ProductionOption pipes(pipes_outputs, pipes_inputs, 1.0,
                                pipes_costofanother);
        ...
        ProductionOption bottles(bottles_outputs, bottles_inputs, 100.0,
                                  bottles_costofanother);
        ...
        ProductionOption barrel(barrel_outputs, barrel_inputs, 100.0,
                                 barrel_costofanother);
            ...
            new Factory(1000000, economy, standard_profitrate,
                        "assembly line");
        ...
        ProductionOption tractors(tractors_outputs, tractors_inputs, 10.0,
                                   tractors_costofanother);
        ...
        ProductionOption cars(cars_outputs, cars_inputs, 10.0,
                               cars_costofanother);
            ...
            //==========================
            Factory * workers =
            new Factory(1000000, economy, standard_profitrate, "workers");
        ...
        ProductionOption workforce(workforce_outputs, workforce_inputs,
                                    50.0, workforce_costofanother);
            ...
            //==========================
            Factory * workers2 =
            new Factory(1000000, economy, standard_profitrate, "workers2");
        ...
        ProductionOption workforce1(workforce1_outputs, workforce1_inputs,
                                     50.0, workforce1_costofanother);
        ...
        ProductionOption workforce2(workforce2_outputs, workforce2_inputs,
                                     50.0, workforce2_costofanother);
            ...
            //==========================
            Factory * mine =
            new Factory(1000000, economy, 0.001, "iron mine");
        ...
        Products mine_costofanother;
        ...
        ProductionOption poMine(mine_outputs, mine_inputs, 10.0,
                                 mine_costofanother);
            ...
            new Consumer(0.0, economy, consumption1, "the working class",
                         standard_profitrate);
            ...
            new Consumer(0.0, economy, consumption2, "the middle class",
                         standard_profitrate);
...
//end test
    ...
     cerr << "total millisec for all operations: " << (int) total <<
        endl;
